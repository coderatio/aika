...
<head>
    ...
    <title>UI Overview | Dashboard UI Kit</title>
...
<header class="c-navbar u-mb-large">
    <a class="c-navbar__brand u-mr-zero" href="#!">
        <img src="img/logo.png" alt="Dashboard's Logo">
    </a>

    <h1 class="u-h4 u-m-zero u-ml-small">UI Overview</h1>

    <div class="u-ml-auto u-text-right">
        <p class="u-mb-zero">Dashboard UI Kit</p>
        <p class="u-text-mute u-text-xsmall">Zawia Studio</p>
    </div>
</header>
...
<div class="container">
        ...
        <div class="col-sm-6 col-md-3 u-mb-medium">
            ...
            <div class="u-block u-mb-xsmall">
                <div class="c-switch is-active">
                    ...
                    <label class="c-switch__label" for="switch2">On</label>
                </div>
            </div>
        ...
        <div class="col-md-8">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <form action="https://zawiastudio.com/file-upload" class="dropzone" id="custom-dropzone" style="height: 180px;">
    ...
    <div class="row u-mb-xlarge">
        <div class="col-sm-4 u-mb-medium">
            ...
            <!-- Modal -->
            <div class="c-modal modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModal1" data-backdrop="static">
        ...
        <div class="col-sm-4 u-mb-medium">
            ...
            <!-- Modal -->
            <div class="c-modal modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModal2">
                <div class="c-modal__dialog modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="c-plans">
                            <header class="c-plans__header">
                                <h4 class="c-plans__title">Small startup? Big company? We’ve got a plan.</h4>
                                <p class="c-plans__description">Pricing is based on two things: Number of opened projects, and the number of seats you want for your team. Plans start at $19/month.</p>
                            </header>

                            <button class="c-plans__close c-close" data-dismiss="modal" aria-label="Close">
                                <i class="fa fa-close"></i>
                            </button>

                            <div class="c-plans__body">
                                <div class="row">
                                    <div class="col-md-3 u-nospace">
                                ...
                                <p class="c-plans__description">Have a larger team? <a href="#">Contact us</a> for information about more enterprise options.</p>
                            </div><!-- // .c-plans__body -->


                            <footer class="c-plans__footer">
    ...
    <div class="row u-mb-xlarge">
        <div class="col-lg-6 u-mb-medium">
            ...
            <div class="c-alert c-alert--warning alert">
        ...
        <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-6">
                    <button type="button" class="c-btn c-btn--secondary u-mb-medium" data-toggle="popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
                        Popover on top
                    </button>



                    <button type="button" class="c-btn c-btn--secondary" data-toggle="popover" data-placement="right" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
                        Popover on right
                    </button>
                </div>
                <div class="col-6 u-mb-medium">
                    <button type="button" class="c-btn c-btn--secondary u-mb-medium" data-toggle="popover" data-placement="bottom" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
                        Popover on bottom
                    </button>

                    <button type="button" class="c-btn c-btn--secondary" data-toggle="popover" data-placement="left" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
                        Popover on left
                    </button>
                </div>
            </div>
        ...
        <div class="col-sm-12">
            <table class="c-table u-mb-small">
                ...
                <tr class="c-table__row">
                    ...
                    <td class="c-table__cell u-text-right">
                        <div class="c-dropdown dropdown">
                            <button class="c-btn c-btn--secondary has-dropdown dropdown-toggle" id="dropdownMenuButton13" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</button>

                            <div class="c-dropdown__menu dropdown-menu" aria-labelledby="dropdownMenuButton13">
                                <a class="c-dropdown__item dropdown-item" href="#">Edit Profile</a>
                                <a class="c-dropdown__item dropdown-item" href="#">View Activity</a>
                                <a class="c-dropdown__item dropdown-item" href="#">Manage Roles</a>
                            </div>
                ...
                <tr class="c-table__row c-table__row--danger">
                    ...
                    <td class="c-table__cell u-text-right">
                        <div class="c-dropdown dropdown">
                            <button class="c-btn c-btn--secondary has-dropdown dropdown-toggle" id="dropdownMenuButton14" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</button>

                            <div class="c-dropdown__menu dropdown-menu" aria-labelledby="dropdownMenuButton14">
                                <a class="c-dropdown__item dropdown-item" href="#">Edit Profile</a>
                                <a class="c-dropdown__item dropdown-item" href="#">View Activity</a>
                                <a class="c-dropdown__item dropdown-item" href="#">Manage Roles</a>
                            </div>
                ...
                <tr class="c-table__row">
                    ...
                    <td class="c-table__cell u-text-right">
                        <div class="c-dropdown dropdown">
                            <button class="c-btn c-btn--secondary has-dropdown dropdown-toggle" id="dropdownMenuButton15" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</button>

                            <div class="c-dropdown__menu dropdown-menu" aria-labelledby="dropdownMenuButton15">
                                <a class="c-dropdown__item dropdown-item" href="#">Edit Profile</a>
                                <a class="c-dropdown__item dropdown-item" href="#">View Activity</a>
                                <a class="c-dropdown__item dropdown-item" href="#">Manage Roles</a>
                            </div>
                ...
                <tr class="c-table__row">
                    ...
                    <td class="c-table__cell u-text-right">
                        <div class="c-dropdown dropdown">
                            <button class="c-btn c-btn--secondary has-dropdown dropdown-toggle" id="dropdownMenuButton16" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</button>

                            <div class="c-dropdown__menu dropdown-menu" aria-labelledby="dropdownMenuButton16">
                                <a class="c-dropdown__item dropdown-item" href="#">Edit Profile</a>
                                <a class="c-dropdown__item dropdown-item" href="#">View Activity</a>
                                <a class="c-dropdown__item dropdown-item" href="#">Manage Roles</a>
                            </div>
                ...
                <tr class="c-table__row">
                    ...
                    <td class="c-table__cell u-text-right">
                        <div class="c-dropdown dropdown">
                            <button class="c-btn c-btn--secondary has-dropdown dropdown-toggle" id="dropdownMenuButton17" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown</button>

                            <div class="c-dropdown__menu dropdown-menu" aria-labelledby="dropdownMenuButton17">
                                <a class="c-dropdown__item dropdown-item" href="#">Edit Profile</a>
                                <a class="c-dropdown__item dropdown-item" href="#">View Activity</a>
                                <a class="c-dropdown__item dropdown-item" href="#">Manage Roles</a>
                            </div>
    ...
    <table class="c-table u-mb-xlarge">
        <tbody>
        <tr class="c-table__row">
...
<script src="js/main.minffaf.js?v=1.4"></script>
<script>
