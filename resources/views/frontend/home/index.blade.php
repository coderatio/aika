    ...
    <div class="row">
        <div class="col-sm-12 col-lg-4">
            <div class="c-card u-p-medium u-text-center u-mb-medium" data-mh="landing-cards">
                ...
                <img class="u-mb-small" src="{{ asset('assets/img/icon-intro1.svg') }}" alt="iPhone icon">
        ...
        <div class="col-sm-12 col-lg-4">
            <div class="c-card u-p-medium u-text-center u-mb-medium" data-mh="landing-cards">
                ...
                <img class="u-mb-small" src="{{ asset('assets/img/icon-intro2.svg') }}" alt="iPhone icon">
        ...
        <div class="col-sm-12 col-lg-4">
            <div class="c-card u-p-medium u-text-center u-mb-medium" data-mh="landing-cards">
                ...
                <img class="u-mb-small" src="{{ asset('assets/img/icon-intro3.svg') }}" alt="iPhone icon">
        ...
        <div class="col-lg-6">
            ...
            <div class="c-card u-p-medium">
                <div class="c-fileitem">
                    <div class="c-fileitem__content">
                        <div class="c-fileitem__img">
                            <img src="{{ asset('assets/img/recent1.jpg') }}" alt="File's image">
                        </div>

                        <p class="c-fileitem__name">
                            <img src="{{ asset('assets/img/icon-pdf.svg') }}" alt="PDF icon">Santorini.pdf
                        </p>
                    </div>
                ...
                <div class="c-fileitem">
                    <div class="c-fileitem__content">
                        <div class="c-fileitem__img">
                            <img src="{{ asset('assets/img/recent2.jpg') }}" alt="File's image">
                        </div>

                        <p class="c-fileitem__name">
                            <img src="{{ asset('assets/img/icon-pdf.svg') }}" alt="PDF icon">Sea Presentation.pdf
                        </p>
                    </div>
                ...
                <div class="c-fileitem">
                    <div class="c-fileitem__content">
                        <div class="c-fileitem__img">
                            <img src="{{ asset('assets/img/recent3.jpg') }}" alt="File's image">
                        </div>

                        <p class="c-fileitem__name">
                            <img src="{{ asset('assets/img/icon-doc.svg') }}" alt="PDF icon">Lakes in Austria.doc
                        </p>
                    </div>
                ...
                <div class="c-fileitem">
                    <div class="c-fileitem__content">
                        <div class="c-fileitem__img">
                            <img src="{{ asset('assets/img/recent4.jpg') }}" alt="File's image">
                        </div>

                        <p class="c-fileitem__name">
                            <img src="{{ asset('assets/img/icon-pdf.svg') }}" alt="PDF icon">Mountain.pdf
                        </p>
                    </div>
                ...
                <div class="c-fileitem">
                    <div class="c-fileitem__content">
                        <div class="c-fileitem__img">
                            <img src="{{ asset('assets/img/recent5.jpg') }}" alt="File's image">
                        </div>

                        <p class="c-fileitem__name">
                            <img src="{{ asset('assets/img/icon-doc.svg') }}" alt="PDF icon">Mountains in US.doc
                        </p>
                    </div>
